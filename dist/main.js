...
var CWD = process.cwd();
var CHUNK_SIZE = 150 * 1024 * 1024; // 150 mb
console.log("searching for " + GLOB + " in " + CWD);
glob(GLOB, {}, function (err, files) { return __awaiter(void 0, void 0, void 0, function () {
    var _i, files_1, file, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                err_1 = _a.sent();
                core.setFailed('Error: upload failed', err_1);
                return [3 /*break*/, 7];
